...
function renderSlide(slide) {
  ...
  // TEMPORARY debug aid: update the on-screen slide number.
  const debugNum = document.getElementById("debug-slide-num");
  if (debugNum) debugNum.textContent = "Slide " + slide.id;
